...
During the former tunning, we have shrinked the parameters to 8 groups. In the part, we added two tunning parameters "$\lambda$" and "Kernel Type" to the combination, each one has two possible choices.
